...
export default {
  name: 'DirectorApproveDialogApproveStatusRadioGroup',
  components: {
    BaseListItemLabelRadioGroup,
  },
  props: {
  ...
  methods: {
    ...
    rule(value) {
      ...
      const errorMsg = i18n.t('views.admin.director.directorApproveList.modalErrorServiceUserApproveStatusWait');
